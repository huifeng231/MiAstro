...
from utils.exceptions import RedisClientError
from utils.utils import ignore_error
...
class AIORedisClient(object):
    ...
    def init_app(self, app, *, host=None, port=None, dbname=None, passwd="", pool_size=None):
        ...
        print("host %s port %s dbname %s passwd %s " % (host, port, dbname, passwd))
...
rds = AIORedisClient(pool_size=10)
